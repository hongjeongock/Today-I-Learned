...
<table class="tg" style="undefined;table-layout: fixed; width: 315px"><colgroup>
...
<thead>
  <tr>
    <th class="tg-uzvj">제한자</th>
    <th class="tg-wa1i">외부</th>
    <th class="tg-wa1i">내부</th>
    <th class="tg-wa1i">상속 관계</th>
  </tr></thead>
<tbody>
  <tr>
    <td class="tg-cly1">public</td>
...
<table class="tg"><thead>
  <tr>
    <th class="tg-9wq8">상황</th>
    <th class="tg-9wq8">적합한 선택</th>
  </tr></thead>
<tbody>
  <tr>
    <td class="tg-lboi">전역 데이터 관리</td>
    <td class="tg-lboi">static</td>
  </tr>
  <tr>
    <td class="tg-lboi">반드시 하나만 존재해야 하는 객체</td>
    <td class="tg-lboi">static 또는 싱글톤</td>
  </tr>
  <tr>
    <td class="tg-lboi">개별적이고 독립적인 객체 여러 개 필요</td>
    <td class="tg-lboi">인스턴스 (static X)</td>
  </tr>
  <tr>
    <td class="tg-lboi">공통 기능 묶기</td>
    <td class="tg-lboi">static 클래스</td>
  </tr>
  <tr>
    <td class="tg-lboi">중복 코드 제거</td>
    <td class="tg-lboi">상속</td>
  </tr>
  <tr>
    <td class="tg-lboi">여러 객체를 상위 타입으로 묶어 관리</td>
    <td class="tg-lboi">상속 + 다형성</td>
  </tr>
</tbody>
</table>